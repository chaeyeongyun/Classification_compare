...
def train(opt):
    ...
    start_epoch, load_model, dataset_path = opt.start_epoch, opt.load_model, opt.dataset_path
    ...
    save_model_path = './save_files/'+f"{dt.month}-{dt.day}-{dt.hour}-{dt.minute}"
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if test_acc > best_test_acc:
            torch.save(model.state_dict(), save_model_path+ f'/{num_epochs}ep_{batch_size}b_best.pt')
